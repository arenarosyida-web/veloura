...
<div class="max-w-2xl font-jost space-y-5">
  ...
  <div data-aos="fade-down" data-aos-duration="400">
    ...
    <h1 class="font-cormorant text-3xl font-normal text-brand-900">Tambah Kategori</h1>
    ...
    <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data"
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <input type="text" name="name" value="{{ old('name') }}" required
               placeholder="mis. Kue Ulang Tahun"
      ...
      <div class="flex flex-col gap-1.5">
        <label class="text-[11px] font-medium uppercase tracking-[2px] text-brand-900">
          Gambar Kategori <span class="text-red-600 font-semibold">*</span>
        </label>
      ...
      <div id="preview-container" class="hidden flex flex-col gap-1.5">
        <p class="text-[11px] font-medium uppercase tracking-[2px] text-brand-900">Preview</p>
